...
<body>
    ...
    <section class="container">
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        ...
        <a href="html/teladelogin.php" ><button class="btn btn-outline" >  Jogos de Hoje</button></a>
        <a href="html/teladelogin.php" ><button class="btn btn-outline"> Sobre.</button></a>
       
      </div>
      <div class="box" id="user" style="position:absolute; left:80%; top:12%;font-size:85%; background-color:rgb(42, 0, 192);">
        <a href="html/teladelogin.php"><button class="btn btn-outline" style="color: white;" >Login</button></a>
        <a href="html/cadastro.php"><button class="btn btn-outline" style="color: white;">Cadastre-se</button></a>
      </div>
    
    
      <div class="playercentral">
        <a href="#referencia"><img src="imagens/player-icon-png-10.jpg" alt="" height="20%" width="20%"></a>
      </div>
